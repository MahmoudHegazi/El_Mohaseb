...
<!-- js code for hide the alert after 3sec old search -->
<!-- 
...
-->	   
        ...
        <div class="container">
          ...
          <div class="row blog-entries">
            ...
            <!-- END main-content -->
			<!-- ?path=<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?> -->

            <div class="col-md-12 col-lg-4 sidebar">
              <div class="sidebar-box search-form-wrap">
                <form method="post" action="nsearch.php" class="search-form" name="searchs">
